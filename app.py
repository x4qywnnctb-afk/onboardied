...
def create_chart_02_keywords():
    """Chart 2: Tag Cloud — 4-row layout, safe font sizes, no overlap"""
    ...
    fig.text(0.5, 0.96,
             'Chart 2: Top Onboarding Issues — Tag Cloud',
             ha='center', va='top',
    ...
    os.makedirs('adyen_charts', exist_ok=True)
    plt.savefig('adyen_charts/02_top_keywords.png', dpi=DPI, bbox_inches='tight',
    ...
    try:
        ...
        pfig.update_layout(
            ...
            title=dict(text='Chart 2: Top Onboarding Issues — Tag Cloud',
                       font=dict(size=16, color='#00112c',
                                 family='Inter, Arial, sans-serif'),
                       x=0.5, xanchor='center')
        )
        pfig.write_html('adyen_charts/02_top_keywords.html',
...
with st.sidebar:
    ...
    selected_chart = st.selectbox(
        ...
        [
            ...
            "Chart 2: Top Onboarding Issues",
            "Chart 3: Research Intelligence"
        ],
...
elif selected_chart == "Chart 2: Top Onboarding Issues":
    st.markdown(f"""
        <h2 style='color: {ADYEN_MIDNIGHT}; font-size: 1.8rem; font-weight: 600; margin-bottom: 1rem;'>
            Chart 2: Top Onboarding Issues
        </h2>
...
# ============================================
elif selected_chart == "Chart 3: Research Intelligence":
    st.markdown(f"""
        <h2 style='color: {ADYEN_MIDNIGHT}; font-size: 1.8rem; font-weight: 600; margin-bottom: 0.5rem;'>
            Chart 3: Engineering Onboarding Intelligence
        </h2>
        <p style='color: {ADYEN_SECONDARY}; font-size: 1rem; margin-bottom: 1.5rem;'>
